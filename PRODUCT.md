...
- Full illustrated art for all 5 wardrobe skins (`assets/sprites/skins/<id>/`, 12 run + 4 jump + 2 idle frames each, background-removed and auto-trimmed from the user-supplied reference sheets kept in `assets/skins/`).
